INSERT IGNORE INTO `regions` (`id`, `region`) VALUES
(1, 'Республика Адыгея'),
...
(94, 'Территории находящиеся за пределами РФ и обслуживаемые Управлением режимных объектов МВД России или Байконур'),
